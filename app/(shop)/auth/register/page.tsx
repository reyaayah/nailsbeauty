            ...
            <div className="w-full max-w-md">
                ...
                <div className="text-center mb-10">
                    ...
                    <p className="text-sm font-medium text-slate-600">
                        Join Gloss & Grace and start your beauty journey
                    </p>
                </div>
                ...
                <p className="text-center text-sm mt-10 text-slate-600 font-medium">
                    ...
                    <Link href="/auth/login" className="font-bold border-b-2 border-black pb-0.5 transition-colors" style={{ color: theme.colors.dark, borderColor: theme.colors.primary }}>
                        Sign in
                    </Link>
                </p>
            </div>
