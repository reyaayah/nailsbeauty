                ...
                <div className="max-w-5xl mx-auto relative">
                    ...
                    <div style={{ backgroundColor: theme.colors.primary }} className=" rounded-[3rem] p-12 md:p-20 text-center text-white overflow-hidden relative">
                        ...
                        <div className="relative z-10 max-w-2xl mx-auto">
                            ...
                            <button style={{ color: theme.colors.primary }} className="group relative bg-white px-12 py-4 rounded-full font-black uppercase tracking-widest text-xs transition-all   overflow-hidden shadow-xl">
